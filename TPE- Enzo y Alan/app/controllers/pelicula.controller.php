    ...
    public function addPelicula()
{
    ...
    public function editPelicula($id_pelicula) {
        AuthHelper::verify();
    
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            $this->view->showEdit($id_pelicula);
            ...
            // Update the movie
            $this->model->actualizarPelicula($id_pelicula, $titulo, $director, $fechaLanzamiento, $sinopsis);
